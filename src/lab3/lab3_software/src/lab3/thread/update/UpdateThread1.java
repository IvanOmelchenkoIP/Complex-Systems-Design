...
public class UpdateThread1 implements Runnable {
	...
	public UpdateThread1(String url, SQLConnectionManager sqlConnectionManager, int loops, Lock lock,
	...
	public void run() {
		...
		try {
			...
			System.out.println("Помилка при встановленні з\'єднання з базою даних у потоці UPDATE 1...");
		...
		try {
			...
			System.out.println("Помилка у роботі потоку UPDATE 1...");
			System.out.println(e);
			return;
		} finally {
			countDownLatch.countDown();
